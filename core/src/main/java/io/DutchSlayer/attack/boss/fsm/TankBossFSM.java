...
public class TankBossFSM {
    ...
    public TankBossFSM(TankBoss owner, OrthographicCamera camera) {
        this.owner = owner;
        this.camera = camera;
    ...
    public void update(float delta) {
        ...
        float prepareChargeTime = 1f;
        float burstCooldownTime = 1f;
        float preGrenadeDelayTime = 2.5f;
        float grenadeTossCooldownTime = 0.5f;
        float entrySpeed = 400f;
        switch (currentState) {
            case ENTERING_ARENA:
